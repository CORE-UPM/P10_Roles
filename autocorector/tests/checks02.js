...
describe("Tests Práctica 10 - Servicio Web", function() {
    ...
    describe("Prechecks", function () {
	      scored(`Comprobando que existe la carpeta de la entrega: ${PATH_ASSIGNMENT}`, -1, async function () {
        ...
        scored(`Comprobar que los controladores existen`, -1, async function () {
            ...
            for (let mw of ["load", "index", "show", "new", "create", "edit", "update", "destroy", "attachment", "adminOrAuthorRequired" ]) {
            ...
            for (let mw of ["new", "create", "destroy", "loginRequired", "adminOrMyselfRequired"]) {
